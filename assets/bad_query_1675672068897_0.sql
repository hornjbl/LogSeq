...
ON a.LimitReference = b.LimitReference			-- NONCLUSTERED INDEX on a and b - high-selectivity
AND a.BusinessDate = b.BusinessDate				-- NONCLUSTERED INDEX on a and b - Used frequently in JOIN and WHERE clauses
AND ISNULL(convert(varchar, a.UtilizationStepNo), '') = ISNULL(convert(varchar, b.LimitStepNo), '') -- NO index - low selectivity?
...
-- TPS.WhExposureAndUtil
-- Rowcount: 24,955,204
-- Distinct UtilizationStepNo: 16
-- Distinct LimitReference: 108,055

-- TPS.WhLimits - 167,874,195
-- Distinct LimitReference: 141,369


--sp_spaceused 'TPS.WhLimits'

--name	rows	reserved	data	index_size	unused
--WhExposureAndUtil	25660001            	4538928 KB	3799632 KB	737728 KB	1568 KB

--name	rows	reserved	data	index_size	unused
--WhLimits	167874195           	9547280 KB	4064312 KB	5450024 KB	32944 KB